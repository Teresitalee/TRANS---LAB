...
require('../src/assets/js/validate'); //Sólo enlaza el archivo, parecido al script de html
...
describe('Validar emails', ()=>{ //Describe lo que habrá dentro de cada función
    describe('Debería verificar si existe el arroba', ()=>{
        ...
        it('Debería el correo tener un arroba antes del dominio', ()=>{
            ...
            assert.equal(validateEmail("teresita1852@gmail.com"), true);
        });
    });(
    ...
    describe('Debería verificar que tenga al menos 5 caracter antes del arroba', ()=>{
